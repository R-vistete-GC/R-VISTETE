...
urlpatterns = [
    ...
    # Dashboard
 path('dashboard/recomendaciones-estilo-color/', views.recomendaciones_estilo_color, name='recomendaciones_estilo_color'),    path('dashboard/', views.dashboard, name='dashboard'),
